...
class StaffAndCertificatesStateDao {
  static getStaffAndCertificatesStateInfo() async {
    var res;
    res = await HttpManager.netFetch(
        Address.getStaffAndCertificatesState(),
        null,
        null,
    ...
    if (res.code == Config.ERROR_CODE401 || res.code == Config.ERROR_CODE403) {
      ...
      res = await HttpManager.netFetch(
          Address.getStaffAndCertificatesState(), null, null, null);
    }
    if (res != null && res.result) {
      ...
      if (res.data["result"] != null) {
        ...
        print("staffAndCertificatesStateInfo.ls" +
            json.encode(res.data["result"]));
