...
class TollDao{
  static getTollInquiry(happenDateBegin, happenDateEnd, skipCount) async {
    var res;
    res = await HttpManager.netFetch(Address.getTollInquiry() + "?HappenDate=${happenDateBegin}&HappenDateTo=${happenDateEnd}&MaxResultCount=${Config.PAGE_SIZE}&SkipCount=${skipCount}", null, null, null);
    if(res.code == 403){
